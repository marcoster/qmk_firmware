...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTRL, KC_Z,   KC_X,     KC_C,    KC_V,    KC_B,     KC_MUTE,       XXXXXXX, KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                    ...
                    QK_BOOT, KC_LALT, KC_LGUI, KC_LOWER, KC_RAISE,      KC_ENT,  KC_SPC, KC_RGUI, KC_RALT, QK_BOOT
),
...
[_COLEMAK] = LAYOUT(
  ...
  KC_LCTRL, KC_Z,   KC_X,     KC_C,    KC_V,    KC_B,     KC_MUTE,      XXXXXXX, KC_K,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                    //KC_LCTRL, KC_LALT, KC_LGUI, KC_LOWER, KC_RAISE,     KC_ENT,  KC_SPC, KC_RGUI, KC_RALT, KC_RCTRL
                    QK_BOOT, KC_LALT, KC_LGUI, KC_LOWER, KC_RAISE,     KC_ENT,  KC_SPC, KC_RGUI, KC_RALT, QK_BOOT
),
/*
...
[_GAME] = LAYOUT(
  ...
  KC_LCTRL, KC_Z,   KC_X,     KC_C,    KC_V,    KC_B,   KC_MUTE,       XXXXXXX, KC_N,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                    KC_CIRC,  KC_M,    KC_LALT, KC_SPC, KC_ENT,        KC_RAISE,KC_LOWER, KC_RGUI, KC_RALT, KC_RCTRL
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
